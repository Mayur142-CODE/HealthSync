                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card card-modern mb-4">
                            ...
                            <div class="card-body">
                                <form id="profileForm" action="../doctor/profile" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" class="form-control" id="email" 
                                                   value="<%= doctor.getEmail() %>" readonly disabled>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="experience" name="experience" 
                                                   value="<%= doctor.getExperience() %>" min="0" required>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-modern mb-4">
                            ...
                            <div class="card-body">
                                <form id="passwordForm" action="../doctor/profile" method="POST">
                        ...
                        <div class="card card-modern">
                            ...
                            <div class="card-body">
                                <p class="mb-2"><strong>Doctor ID:</strong> <%= doctor.getDoctorId() %></p>
                                <p class="mb-2"><strong>Status:</strong> 
                                    <span class="badge bg-success"><%= doctor.getStatus() %></span>
                                </p>
                                <p class="mb-0"><strong>Joined:</strong> <%= doctor.getDateJoined() %></p>
                            </div>
                        </div>
                    </div>
                </div>
