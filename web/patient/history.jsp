...
<head>
    ...
    <title>My History - HealthSync</title>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../patient/history">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2 text-primary">
                        <i class="fas fa-history me-2"></i>My Medical History
                    </h1>
                </div>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Dr. <%= appointment.getDoctorName() %></td>
                                                <td>
                                                    <span title="<%= appointment.getReason() %>">
                                                        <%= appointment.getReason().length() > 25 ? 
                                                            appointment.getReason().substring(0, 25) + "..." : 
                                            ...
                                            %>
                                            <tr>
                                                <td colspan="3" class="text-center text-muted">No past appointments</td>
                                            </tr>
                                            <% } %>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Dr. <%= prescription.getDoctorName() %></td>
                                                <td>
                                                    <span title="<%= prescription.getDiagnosis() %>">
                                                        <%= prescription.getDiagnosis().length() > 20 ? 
                                                            prescription.getDiagnosis().substring(0, 20) + "..." : 
                                            ...
                                            %>
                                            <tr>
                                                <td colspan="4" class="text-center text-muted">No prescriptions available</td>
                                            </tr>
                                            <% } %>
                                        </tbody>
                                    </table>
